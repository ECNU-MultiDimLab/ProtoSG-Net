...
from models.protosg import ProtoSGModel
import warnings
...
def parse_agrs():
    ...
    parser.add_argument('--base_dir', type=str,
                        default='./Datasets/TCGA-NSCLC/',
                        help='the path to the directory containing the encoded wsi patches.')
    parser.add_argument('--image_dir', type=str,
                        default='./TCGA-NSCLC/uni_512/UNI_2D_h5_files_w_4_4',
                        help='the path to the directory containing the encoded wsi patches.')
    parser.add_argument('--ann_path', type=str,
                        default='./TCGA-NSCLC/uni_512/UNI_2D_h5_files_w_4_4',
                        help='the path to the directory containing the data.')
    # Data loader settings
    parser.add_argument('--dataset_name', type=str, default='TCGA', choices=['TCGA', 'camelyon+'],
                        help='the dataset to be used.')
    parser.add_argument('--n_classes', type=int, default=2, help='how many classes to predict')
    parser.add_argument('--k_sample', type=int, default=3500, help='the number of samples for a batch.')
    ...
    parser.add_argument('--save_dir', type=str, default='./results/TCGA-NSCLC/',
    ...
    # debug
    parser.add_argument("--checkpoint_dir", type=str, default='./results/TCGA-NSCLC/')
...
def main(local_rank, world_size):
    ...
    model = ProtoSGModel(args).to(local_rank)
